...
\section {Реферат}
\end{center}
Отчет 16 с., 1 кн., 8 рис., 2 табл., 24 источн., 1 прил.\\
~\\
...
\end{center}	
\begin{figure}[h]
\center{\includegraphics[draft=false,width=1\linewidth]{Fake}}
...
\begin{figure}[h]
\center{\includegraphics[draft=false,width=\linewidth/3]{tetris_example}}
...
\begin{figure}[h]
\center{\includegraphics[draft=false,width=\linewidth/2]{network}}
...
\begin{figure}[h]
\center{\includegraphics[draft=false,width=\linewidth/2]{VMRequests}}
\caption{Схема базы данных запросов пользователей Microsoft Azure\cite{litlink22}.}
\label{ris:image}
\end{figure}\\
\begin{figure}[h]
\center{\includegraphics[draft=false,width=\linewidth/2]{VMTypes}}
...
\begin{figure}[h]
\center{\includegraphics[draft=false,width=\linewidth/2]{Algorithm}}
...
\begin{figure}[h!]
\center{\includegraphics[draft=false,width=\linewidth/2]{timeline}}
...
\begin{figure}[h!]
\center{\includegraphics[draft=false,width=\linewidth/2]{model_format}}
